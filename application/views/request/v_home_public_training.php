							...
							<div class="card card-tabs">
								...
								<div class="card-body">
									...
									<div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
										...
										<div class="card-body">
											<a class="btn btn-info" style="background-color:#273b7a; border-color:#273b7a; margin-bottom:20pt "; href="<?php echo base_url().'public_training/create_training' ?>" class="nav-link">
											...
											<table id="example" class="table table-bordered table-striped">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a class="btn btn-success btn-sm" style="background-color:#1a9e38; border-color:#1a9e38;" href="<?php echo base_url().'Public_training/edit_public_training/'.$data->id; ?>" class="nav-link"><i class="fas fa-pencil-alt"></i>Edit</a>
															<a class="btn btn-success btn-sm btn-danger" style="background-color:#bd0011; border-color:#bd0011"; href="<?php echo base_url().'Public_training/edit_public_training/'.$data->id; ?>" class="nav-link"><i class="fas fa-trash-alt"></i>Hapus</a>
