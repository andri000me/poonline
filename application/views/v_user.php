...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url();?>admin/index3.html" class="brand-link">
      <img src="<?php echo base_url();?>admin/dist/img/AdminLTELogo.png"
           alt="AdminLTE Logo"
                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo base_url();?>admin/dist/img/avatar.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo base_url();?>admin/dist/img/avatar2.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo base_url();?>admin/dist/img/avatar3.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo base_url();?>admin/dist/img/avatar04.png">
                              </li>
                          </ul>
                      </td>
                  ...
                  <tr>
                      ...
                      <td>
                          <ul class="list-inline">
                              ...
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="<?php echo base_url();?>admin/dist/img/avatar5.png">
                              </li>
                          </ul>
                      </td>
                      <td class="project_progress">
