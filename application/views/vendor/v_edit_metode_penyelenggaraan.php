...
<?php $this->load->view('template/header'); ?>
  <title>Edit Metode Penyelenggaraan</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Metode Penyelenggaraan Training</h1>
          </div>
        </div>
      </div>
    </section>  
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              <form role="form" action="<?php echo base_url(). 'Metode_penyelenggaraan/edit_metode_penyelenggaraan'; ?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label>Metode</label>
                    <input type="hidden" name="id" value="<?php echo $data[0]->id ?>">
                    <input type="text" class="form-control" name="metode" placeholder="Isikan metode penyelenggaraan training" value="<?php echo $data[0]->metode ?>" required>
                  </div>
